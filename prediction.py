...
class border_prediction():
    def __init__(self, dct_coefs, dc_preset):
        """
        Border prediction from Qiu et al. Predict DC 
        from four corners of the 8x8 image block.
        """
...
class inside_prediction():
    def __init__(self, Qs, dct_coefs, dc_preset):
        """
        Inside prediction. Predict DC from inside four corners 
        of the 8x8 image block. Border prediction is a special 
        case of inside prediction.
